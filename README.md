# Uikit 2 Gutenberg Blocks for WordPress

This plugin is only developed till Beans gets UiKit 3.
...
This plugin adds Uikit 2 components and layout options as Gutenberg blocks.
